  ...
  <div class="h-full">
    ...
    >
      ...
      <div class="overflow-y-auto h-[calc(100vh-64px)] scrollbar-thin scrollbar-thumb-gray-300 dark:scrollbar-thumb-gray-600">
        <nav class="p-4">
          <div class="mb-4">
            <h2 v-if="sidebarOpen" class="font-medium text-sm text-gray-500 dark:text-gray-400 px-3 mb-2 transition-opacity duration-300">主导航</h2>
            <router-link 
              to="/" 
          ...
          <!-- 工具分类 -->
          <div>
            <h2 v-if="sidebarOpen" class="font-medium text-sm text-gray-500 dark:text-gray-400 px-3 mb-2 transition-opacity duration-300">工具分类</h2>
                ...
                >
                  <div class="flex items-center justify-between">
                    <div class="flex items-center">
                      ...
                      <span v-if="sidebarOpen" class="ml-2 transition-opacity duration-300">{{ category.name }}</span>
                    </div>
                    <span v-if="sidebarOpen && toolsByCategory && toolsByCategory[category.id]" 
                      class="text-xs px-1.5 py-0.5 bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-400 rounded-full transition-opacity duration-300"
                    >
