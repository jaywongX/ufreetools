  ...
  <nav class="fixed bottom-0 inset-x-0 bg-white dark:bg-gray-800 shadow-lg border-t border-gray-200 dark:border-gray-700 z-40">
    ...
    <div class="flex overflow-x-auto scrollbar-hide py-1">
      ...
      >
        ...
        <span class="text-xs truncate">{{ $t(`categories.${category.id}`) }}</span>
      </button>
    </div>
...
function getCategoryIcon(categoryId) {
  ...
  return iconMap[categoryId] || "M9 3v2m6-2v2M9 19v2m6-2v2M5 9H3m2 6H3m18-6h-2m2 6h-2M7 19h10a2 2 0 002-2V7a2 2 0 00-2-2H7a2 2 0 00-2 2v10a2 2 0 002 2z"
}
