...
<body>
    ...
    <div class="container my-5">
        ...
        <div class="alert alert-primary alert-dismissible fade show" role="alert">
            <strong>欢迎!</strong> 这是一个Bootstrap组件示例页面。
            ...
            <div class="col">
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">这是一个示例卡片，展示Bootstrap的卡片组件。您可以在这里添加更多内容。</p>
            ...
            <div class="col">
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">这是第二个示例卡片，展示Bootstrap的卡片组件。这里可以放置不同的内容。</p>
                        <a href="#" class="btn btn-primary">查看详情</a>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">第三个示例卡片，用于展示Bootstrap的卡片组件布局效果。</p>
                        <a href="#" class="btn btn-primary">查看详情</a>
                    </div>
                </div>
            </div>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <p>这是模态框的内容部分。您可以在这里放置任何HTML内容。</p>
                            </div>
    ...
    <footer class="bg-dark text-white text-center py-4 mt-5">
        <div class="container">
            <p class="mb-0">© 2023 Bootstrap组件示例. 保留所有权利.</p>
        </div>
    </footer>
