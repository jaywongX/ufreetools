export default {
  "name": "Gerador de Endereços da Papua-Nova Guiné - Gere endereços Papua-Nova Guiné reais, informações de identidade e dados de contato online",
  "description": "Gerador gratuito online de endereços da Papua-Nova Guiné que cria endereços Papua-Nova Guiné em formato real, números de identificação, números de telefone, números de cartão de crédito e perfis de identidade completos. Suporta filtragem por província, formatos de exportação JSON/CSV e é executado inteiramente no navegador para proteção de privacidade.",
