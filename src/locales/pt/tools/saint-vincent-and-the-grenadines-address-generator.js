export default {
  "name": "Gerador de Endereços da São Vicente e Granadinas - Gere endereços São Vicente e Granadinas reais, informações de identidade e dados de contato online",
  "description": "Gerador gratuito online de endereços da São Vicente e Granadinas que cria endereços São Vicente e Granadinas em formato real, números de identificação, números de telefone, números de cartão de crédito e perfis de identidade completos. Suporta filtragem por província, formatos de exportação JSON/CSV e é executado inteiramente no navegador para proteção de privacidade.",
  ...
  "turkey": "São Vicente e Granadinas",
