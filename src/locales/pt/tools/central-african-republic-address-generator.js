export default {
  "name": "Gerador de Endereços da República Centro-Africana - Gere endereços República Centro-Africana reais, informações de identidade e dados de contato online",
  "description": "Gerador gratuito online de endereços da República Centro-Africana que cria endereços República Centro-Africana em formato real, números de identificação, números de telefone, números de cartão de crédito e perfis de identidade completos. Suporta filtragem por província, formatos de exportação JSON/CSV e é executado inteiramente no navegador para proteção de privacidade.",
  ...
  "turkey": "República Centro-Africana",
