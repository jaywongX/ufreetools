export default {
  "name": "Gerador de Endereços da Trinidad e Tobago - Gere endereços Trinidad e Tobago reais, informações de identidade e dados de contato online",
  "description": "Gerador gratuito online de endereços da Trinidad e Tobago que cria endereços Trinidad e Tobago em formato real, números de identificação, números de telefone, números de cartão de crédito e perfis de identidade completos. Suporta filtragem por província, formatos de exportação JSON/CSV e é executado inteiramente no navegador para proteção de privacidade.",
