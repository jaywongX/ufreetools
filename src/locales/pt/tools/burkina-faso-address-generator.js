export default {
  "name": "Gerador de Endereços da Burquina Faso - Gere endereços Burquina Faso reais, informações de identidade e dados de contato online",
  "description": "Gerador gratuito online de endereços da Burquina Faso que cria endereços Burquina Faso em formato real, números de identificação, números de telefone, números de cartão de crédito e perfis de identidade completos. Suporta filtragem por província, formatos de exportação JSON/CSV e é executado inteiramente no navegador para proteção de privacidade.",
