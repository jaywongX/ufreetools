export default {
  ...
  featuredIn: "Destacado em:",
  browserExtensionsDesc: "Obtenha todas as ferramentas com um clique via extensão",
  ...
  qq: 'QQ',
  weibo: 'Weibo',
  defaultTitle: 'UFreeTools - Coleção de Ferramentas Gratuitas Online',
  defaultDescription: 'Descubra uma poderosa coleção de ferramentas gratuitas online para aumentar sua produtividade! Inclui ferramentas de processamento de imagem, ferramentas de texto, ferramentas de desenvolvimento e muitas outras funcionalidades práticas.',
  toolShareDescription: 'Estou usando a ferramenta {toolName}, que é uma ferramenta gratuita online que ajuda a resolver diversos problemas. Funcionalidades poderosas, interface limpa e completamente gratuita para usar! Experimente agora!',
  categoryShareDescription: 'Explore ferramentas práticas na categoria {categoryName}, que são completamente gratuitas e fáceis de usar. Inclui várias ferramentas profissionais para aumentar sua produtividade.',
  homeShareDescription: 'UFreeTools - Coleção de ferramentas gratuitas online, que inclui ferramentas de processamento de imagem, ferramentas de texto, ferramentas de desenvolvimento, ferramentas de design e muitas outras funcionalidades práticas. Todos os ferramentas são completamente gratuitas e não requerem registro.',
  searchShareDescription: 'Resultados da busca para "{searchQuery}" em UFreeTools, descubra ferramentas práticas gratuitas online!',
};