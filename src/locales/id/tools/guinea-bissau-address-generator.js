export default {
  "name": "Generator Alamat Guinea-Bissau - Buat alamat Guinea-Bissau nyata, informasi identitas, dan detail kontak secara online",
  "description": "Generator alamat Guinea-Bissau gratis online yang membuat alamat Guinea-Bissau dengan format nyata, nomor identifikasi, nomor telepon, nomor kartu kredit, dan profil identitas lengkap. Mendukung penyaringan provinsi, format ekspor JSON/CSV, dan berjalan sepenuhnya di browser untuk perlindungan privasi.",
  ...
  "idCardTitle": "Kartu Identitas Guinea-Bissau",
