export default {
  "name": "Generator Alamat Saint Lucia - Buat alamat Saint Lucia nyata, informasi identitas, dan detail kontak secara online",
  "description": "Generator alamat Saint Lucia gratis online yang membuat alamat Saint Lucia dengan format nyata, nomor identifikasi, nomor telepon, nomor kartu kredit, dan profil identitas lengkap. Mendukung penyaringan provinsi, format ekspor JSON/CSV, dan berjalan sepenuhnya di browser untuk perlindungan privasi.",
  ...
  "idCardTitle": "Kartu Identitas Saint Lucia",
