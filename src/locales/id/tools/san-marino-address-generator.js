export default {
  "name": "Generator Alamat San Marino - Buat alamat San Marino nyata, informasi identitas, dan detail kontak secara online",
  "description": "Generator alamat San Marino gratis online yang membuat alamat San Marino dengan format nyata, nomor identifikasi, nomor telepon, nomor kartu kredit, dan profil identitas lengkap. Mendukung penyaringan provinsi, format ekspor JSON/CSV, dan berjalan sepenuhnya di browser untuk perlindungan privasi.",
  ...
  "idCardTitle": "Kartu Identitas San Marino",
