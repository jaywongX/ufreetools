export default {
  "name": "Generator Alamat Myanmar (Burma) - Buat alamat Myanmar (Burma) nyata, informasi identitas, dan detail kontak secara online",
  "description": "Generator alamat Myanmar (Burma) gratis online yang membuat alamat Myanmar (Burma) dengan format nyata, nomor identifikasi, nomor telepon, nomor kartu kredit, dan profil identitas lengkap. Mendukung penyaringan provinsi, format ekspor JSON/CSV, dan berjalan sepenuhnya di browser untuk perlindungan privasi.",
  ...
  "idCardTitle": "Kartu Identitas Myanmar (Burma)",
