export default {
  "name": "Generator Alamat Kepulauan Marshall - Buat alamat Kepulauan Marshall nyata, informasi identitas, dan detail kontak secara online",
  "description": "Generator alamat Kepulauan Marshall gratis online yang membuat alamat Kepulauan Marshall dengan format nyata, nomor identifikasi, nomor telepon, nomor kartu kredit, dan profil identitas lengkap. Mendukung penyaringan provinsi, format ekspor JSON/CSV, dan berjalan sepenuhnya di browser untuk perlindungan privasi.",
  ...
  "idCardTitle": "Kartu Identitas Kepulauan Marshall",
