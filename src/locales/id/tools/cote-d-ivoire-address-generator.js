export default {
  "name": "Generator Alamat Côte d’Ivoire - Buat alamat Côte d’Ivoire nyata, informasi identitas, dan detail kontak secara online",
  "description": "Generator alamat Côte d’Ivoire gratis online yang membuat alamat Côte d’Ivoire dengan format nyata, nomor identifikasi, nomor telepon, nomor kartu kredit, dan profil identitas lengkap. Mendukung penyaringan provinsi, format ekspor JSON/CSV, dan berjalan sepenuhnya di browser untuk perlindungan privasi.",
  ...
  "idCardTitle": "Kartu Identitas Côte d’Ivoire",
