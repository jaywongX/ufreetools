export default {
  "name": "Generator Alamat Sierra Leone - Buat alamat Sierra Leone nyata, informasi identitas, dan detail kontak secara online",
  "description": "Generator alamat Sierra Leone gratis online yang membuat alamat Sierra Leone dengan format nyata, nomor identifikasi, nomor telepon, nomor kartu kredit, dan profil identitas lengkap. Mendukung penyaringan provinsi, format ekspor JSON/CSV, dan berjalan sepenuhnya di browser untuk perlindungan privasi.",
  ...
  "idCardTitle": "Kartu Identitas Sierra Leone",
