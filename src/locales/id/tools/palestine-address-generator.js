export default {
  "name": "Generator Alamat Wilayah Palestina - Buat alamat Wilayah Palestina nyata, informasi identitas, dan detail kontak secara online",
  "description": "Generator alamat Wilayah Palestina gratis online yang membuat alamat Wilayah Palestina dengan format nyata, nomor identifikasi, nomor telepon, nomor kartu kredit, dan profil identitas lengkap. Mendukung penyaringan provinsi, format ekspor JSON/CSV, dan berjalan sepenuhnya di browser untuk perlindungan privasi.",
  ...
  "idCardTitle": "Kartu Identitas Wilayah Palestina",
