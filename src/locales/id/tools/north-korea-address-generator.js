export default {
  "name": "Generator Alamat Korea Utara - Buat alamat Korea Utara nyata, informasi identitas, dan detail kontak secara online",
  "description": "Generator alamat Korea Utara gratis online yang membuat alamat Korea Utara dengan format nyata, nomor identifikasi, nomor telepon, nomor kartu kredit, dan profil identitas lengkap. Mendukung penyaringan provinsi, format ekspor JSON/CSV, dan berjalan sepenuhnya di browser untuk perlindungan privasi.",
  ...
  "idCardTitle": "Kartu Identitas Korea Utara",
