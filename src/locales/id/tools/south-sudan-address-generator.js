export default {
  "name": "Generator Alamat Sudan Selatan - Buat alamat Sudan Selatan nyata, informasi identitas, dan detail kontak secara online",
  "description": "Generator alamat Sudan Selatan gratis online yang membuat alamat Sudan Selatan dengan format nyata, nomor identifikasi, nomor telepon, nomor kartu kredit, dan profil identitas lengkap. Mendukung penyaringan provinsi, format ekspor JSON/CSV, dan berjalan sepenuhnya di browser untuk perlindungan privasi.",
  ...
  "idCardTitle": "Kartu Identitas Sudan Selatan",
