export default {
  "name": "Generator Alamat Arab Saudi - Buat alamat Arab Saudi nyata, informasi identitas, dan detail kontak secara online",
  "description": "Generator alamat Arab Saudi gratis online yang membuat alamat Arab Saudi dengan format nyata, nomor identifikasi, nomor telepon, nomor kartu kredit, dan profil identitas lengkap. Mendukung penyaringan provinsi, format ekspor JSON/CSV, dan berjalan sepenuhnya di browser untuk perlindungan privasi.",
  ...
  "idCardTitle": "Kartu Identitas Arab Saudi",
