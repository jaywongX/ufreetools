export default {
  "name": "니카라과 주소 생성기 - 실제 니카라과 주소, 신원 정보 및 연락처 세부 정보 온라인 생성",
  "description": "실제 형식의 니카라과 주소, 신분증 번호, 전화번호, 신용카드 번호 및 완전한 신원 프로필을 만드는 무료 온라인 니카라과 주소 생성기. 주(州) 필터링, JSON/CSV 내보내기 형식을 지원하며 개인 정보 보호를 위해 브라우저에서 완전히 실행됩니다.",
  "inputTitle": "생성 설정",
  "outputTitle": "생성된 결과",
  "generateBtn": "데이터 생성",
