export default {
    name: '태국 주소 생성기 - 실제 태국 주소, 신분 정보 및 연락처 온라인 생성',
    description: '무료 온라인 태국 주소 생성기는 실제 형식의 태국 주소, 신분증 번호, 전화번호, 신용카드 번호 및 완전한 신분 프로필을 생성합니다. 지역 필터링, JSON/CSV 내보내기 형식을 지원하며 개인정보 보호를 위해 브라우저에서 완전히 작동합니다.',
    inputTitle: '생성 설정',
    outputTitle: '생성된 결과',
    generateBtn: '데이터 생성',
    ...
    regions: {
        ...
        'Pathum Thani': '빠투므므',
        'Samut Prakan': '사뭇프라캄',
        'Nakhon Ratchasima': '나꼰라챠시마',
        'Chiang Rai': '치앙라이',
        'Khon Kaen': '꼰깬',
        'Nakhon Si Thammarat': '나꼰시타마라트',
        'Surat Thani': '수랏타니',
        'Udon Thani': '우돈타니',
        'Rayong': '라용',
        'Lampang': '램팡',
