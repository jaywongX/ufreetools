export default {
  "name": "Iraq Address Generator - Generate Real Iraqi Addresses, Identity Info & Contact Details Online",
  "description": "Free online Iraq address generator that creates real-format Iraqi addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
