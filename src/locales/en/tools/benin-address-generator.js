export default {
  "name": "Benin Address Generator - Generate Real Beninese Addresses, Identity Info & Contact Details Online",
  "description": "Free online Benin address generator that creates real-format Beninese addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
