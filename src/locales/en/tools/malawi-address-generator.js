export default {
  "name": "Malawi Address Generator - Generate Real Malawian Addresses, Identity Info & Contact Details Online",
  "description": "Free online Malawi address generator that creates real-format Malawian addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
