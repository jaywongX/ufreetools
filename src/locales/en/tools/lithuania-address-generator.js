export default {
  "name": "Lithuania Address Generator - Generate Real Lithuanian Addresses, Identity Info & Contact Details Online",
  "description": "Free online Lithuania address generator that creates real-format Lithuanian addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
