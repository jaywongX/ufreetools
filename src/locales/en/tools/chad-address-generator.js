export default {
  "name": "Chad Address Generator - Generate Real Chadian Addresses, Identity Info & Contact Details Online",
  "description": "Free online Chad address generator that creates real-format Chadian addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
