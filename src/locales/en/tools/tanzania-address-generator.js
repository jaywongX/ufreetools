export default {
  "name": "Tanzania Address Generator - Generate Real Tanzanian Addresses, Identity Info & Contact Details Online",
  "description": "Free online Tanzania address generator that creates real-format Tanzanian addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
