export default {
  "name": "Guatemala Address Generator - Generate Real Guatemalan Addresses, Identity Info & Contact Details Online",
  "description": "Free online Guatemala address generator that creates real-format Guatemalan addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
