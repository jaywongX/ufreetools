export default {
  "name": "Bolivia Address Generator - Generate Real Bolivian Addresses, Identity Info & Contact Details Online",
  "description": "Free online Bolivia address generator that creates real-format Bolivian addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
