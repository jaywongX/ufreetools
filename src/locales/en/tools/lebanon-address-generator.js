export default {
  "name": "Lebanon Address Generator - Generate Real Lebanese Addresses, Identity Info & Contact Details Online",
  "description": "Free online Lebanon address generator that creates real-format Lebanese addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
