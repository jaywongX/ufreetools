export default {
  "name": "Switzerland Address Generator - Generate Real Swiss Addresses, Identity Info & Contact Details Online",
  "description": "Free online Switzerland address generator that creates real-format Swiss addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
  ...
  "idCardTitle": "Switzerland Test ID",
