export default {
  "name": "Liechtenstein Address Generator - Generate Real Liechtenstein Addresses, Identity Info & Contact Details Online",
  "description": "Free online Liechtenstein address generator that creates real-format Liechtenstein addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
  ...
  "idCardTitle": "Liechtenstein Test ID",
