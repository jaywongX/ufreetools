export default {
  "name": "Uzbekistan Address Generator - Generate Real Uzbek Addresses, Identity Info & Contact Details Online",
  "description": "Free online Uzbekistan address generator that creates real-format Uzbek addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
  ...
  "idCardTitle": "Uzbekistan Test ID",
