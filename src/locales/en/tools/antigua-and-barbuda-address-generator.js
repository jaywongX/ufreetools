export default {
  "name": "Antigua & Barbuda Address Generator - Generate Real Antiguan and Barbudan Addresses, Identity Info & Contact Details Online",
  "description": "Free online Antigua & Barbuda address generator that creates real-format Antiguan and Barbudan addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
  ...
  "idCardTitle": "Antigua and Barbuda Test ID",
