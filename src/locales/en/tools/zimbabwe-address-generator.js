export default {
  "name": "Zimbabwe Address Generator - Generate Real Zimbabwean Addresses, Identity Info & Contact Details Online",
  "description": "Free online Zimbabwe address generator that creates real-format Zimbabwean addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
