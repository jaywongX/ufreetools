export default {
  "name": "Tunisia Address Generator - Generate Real Tunisian Addresses, Identity Info & Contact Details Online",
  "description": "Free online Tunisia address generator that creates real-format Tunisian addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
