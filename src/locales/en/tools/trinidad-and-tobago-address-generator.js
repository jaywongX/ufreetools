export default {
  "name": "Trinidad & Tobago Address Generator - Generate Real Trinidadian and Tobagonian Addresses, Identity Info & Contact Details Online",
  "description": "Free online Trinidad & Tobago address generator that creates real-format Trinidadian and Tobagonian addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
  ...
  "idCardTitle": "Trinidad and Tobago Test ID",
