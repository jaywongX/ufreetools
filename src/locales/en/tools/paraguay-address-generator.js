export default {
  "name": "Paraguay Address Generator - Generate Real Paraguayan Addresses, Identity Info & Contact Details Online",
  "description": "Free online Paraguay address generator that creates real-format Paraguayan addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
