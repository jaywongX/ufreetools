export default {
  "name": "Denmark Address Generator - Generate Real Danish Addresses, Identity Info & Contact Details Online",
  "description": "Free online Denmark address generator that creates real-format Danish addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
