export default {
  "name": "Tonga Address Generator - Generate Real Tongan Addresses, Identity Info & Contact Details Online",
  "description": "Free online Tonga address generator that creates real-format Tongan addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
