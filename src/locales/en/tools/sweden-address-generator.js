export default {
  "name": "Sweden Address Generator - Generate Real Swedish Addresses, Identity Info & Contact Details Online",
  "description": "Free online Sweden address generator that creates real-format Swedish addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
