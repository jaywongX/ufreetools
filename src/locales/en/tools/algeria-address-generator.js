export default {
  "name": "Algeria Address Generator - Generate Real Algerian Addresses, Identity Info & Contact Details Online",
  "description": "Free online Algeria address generator that creates real-format Algerian addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
