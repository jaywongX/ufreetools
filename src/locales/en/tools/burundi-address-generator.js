export default {
  "name": "Burundi Address Generator - Generate Real Burundian Addresses, Identity Info & Contact Details Online",
  "description": "Free online Burundi address generator that creates real-format Burundian addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
