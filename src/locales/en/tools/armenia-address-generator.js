export default {
  "name": "Armenia Address Generator - Generate Real Armenian Addresses, Identity Info & Contact Details Online",
  "description": "Free online Armenia address generator that creates real-format Armenian addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
