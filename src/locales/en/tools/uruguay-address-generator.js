export default {
  "name": "Uruguay Address Generator - Generate Real Uruguayan Addresses, Identity Info & Contact Details Online",
  "description": "Free online Uruguay address generator that creates real-format Uruguayan addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
