export default {
  "name": "Andorra Address Generator - Generate Real Andorran Addresses, Identity Info & Contact Details Online",
  "description": "Free online Andorra address generator that creates real-format Andorran addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
