export default {
  "name": "Ecuador Address Generator - Generate Real Ecuadorian Addresses, Identity Info & Contact Details Online",
  "description": "Free online Ecuador address generator that creates real-format Ecuadorian addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
