export default {
  "name": "Estonia Address Generator - Generate Real Estonian Addresses, Identity Info & Contact Details Online",
  "description": "Free online Estonia address generator that creates real-format Estonian addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
