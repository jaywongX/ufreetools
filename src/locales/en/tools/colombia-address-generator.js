export default {
  "name": "Colombia Address Generator - Generate Real Colombian Addresses, Identity Info & Contact Details Online",
  "description": "Free online Colombia address generator that creates real-format Colombian addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
