export default {
  "name": "St. Lucia Address Generator - Generate Real Saint Lucian Addresses, Identity Info & Contact Details Online",
  "description": "Free online St. Lucia address generator that creates real-format Saint Lucian addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
  ...
  "idCardTitle": "Saint Lucia Test ID",
