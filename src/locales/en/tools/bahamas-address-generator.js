export default {
  "name": "Bahamas Address Generator - Generate Real Bahamian Addresses, Identity Info & Contact Details Online",
  "description": "Free online Bahamas address generator that creates real-format Bahamian addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
