export default {
  "name": "Moldova Address Generator - Generate Real Moldovan Addresses, Identity Info & Contact Details Online",
  "description": "Free online Moldova address generator that creates real-format Moldovan addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
