export default {
  "name": "Congo - Brazzaville Address Generator - Generate Real Congolese Addresses, Identity Info & Contact Details Online",
  "description": "Free online Congo - Brazzaville address generator that creates real-format Congolese addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
  ...
  "idCardTitle": "Republic of the Congo Test ID",
