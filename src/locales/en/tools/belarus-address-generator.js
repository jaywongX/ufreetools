export default {
  "name": "Belarus Address Generator - Generate Real Belarusian Addresses, Identity Info & Contact Details Online",
  "description": "Free online Belarus address generator that creates real-format Belarusian addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
