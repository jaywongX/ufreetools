export default {
  "name": "Kosovo Address Generator - Generate Real Kosovar Addresses, Identity Info & Contact Details Online",
  "description": "Free online Kosovo address generator that creates real-format Kosovar addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
