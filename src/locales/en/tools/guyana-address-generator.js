export default {
  "name": "Guyana Address Generator - Generate Real Guyanese Addresses, Identity Info & Contact Details Online",
  "description": "Free online Guyana address generator that creates real-format Guyanese addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
