export default {
  "name": "Tajikistan Address Generator - Generate Real Tajik Addresses, Identity Info & Contact Details Online",
  "description": "Free online Tajikistan address generator that creates real-format Tajik addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
  ...
  "idCardTitle": "Tajikistan Test ID",
