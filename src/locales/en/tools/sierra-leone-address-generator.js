export default {
  "name": "Sierra Leone Address Generator - Generate Real Sierra Leonean Addresses, Identity Info & Contact Details Online",
  "description": "Free online Sierra Leone address generator that creates real-format Sierra Leonean addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
  ...
  "idCardTitle": "Sierra Leone Test ID",
