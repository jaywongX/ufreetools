export default {
  "name": "Bhutan Address Generator - Generate Real Bhutanese Addresses, Identity Info & Contact Details Online",
  "description": "Free online Bhutan address generator that creates real-format Bhutanese addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
