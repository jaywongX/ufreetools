export default {
  "name": "Somalia Address Generator - Generate Real Somali Addresses, Identity Info & Contact Details Online",
  "description": "Free online Somalia address generator that creates real-format Somali addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
