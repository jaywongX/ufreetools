export default {
  "name": "Rwanda Address Generator - Generate Real Rwandan Addresses, Identity Info & Contact Details Online",
  "description": "Free online Rwanda address generator that creates real-format Rwandan addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
