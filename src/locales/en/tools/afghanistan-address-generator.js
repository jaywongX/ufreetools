export default {
  "name": "Afghanistan Address Generator - Generate Real Afghan Addresses, Identity Info & Contact Details Online",
  "description": "Free online Afghanistan address generator that creates real-format Afghan addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
  ...
  "idCardTitle": "Afghanistan Test ID",
