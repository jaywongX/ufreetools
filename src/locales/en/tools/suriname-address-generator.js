export default {
  "name": "Suriname Address Generator - Generate Real Surinamese Addresses, Identity Info & Contact Details Online",
  "description": "Free online Suriname address generator that creates real-format Surinamese addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
