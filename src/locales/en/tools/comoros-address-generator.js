export default {
  "name": "Comoros Address Generator - Generate Real Comorian Addresses, Identity Info & Contact Details Online",
  "description": "Free online Comoros address generator that creates real-format Comorian addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
