export default {
  "name": "Central African Republic Address Generator - Generate Real Central African Addresses, Identity Info & Contact Details Online",
  "description": "Free online Central African Republic address generator that creates real-format Central African addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
  ...
  "idCardTitle": "Central African Republic Test ID",
