export default {
  "name": "Belgium Address Generator - Generate Real Belgian Addresses, Identity Info & Contact Details Online",
  "description": "Free online Belgium address generator that creates real-format Belgian addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
