export default {
  "name": "Solomon Islands Address Generator - Generate Real Solomon Islander Addresses, Identity Info & Contact Details Online",
  "description": "Free online Solomon Islands address generator that creates real-format Solomon Islander addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
  ...
  "idCardTitle": "Solomon Islands Test ID",
