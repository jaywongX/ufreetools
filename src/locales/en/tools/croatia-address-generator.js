export default {
  "name": "Croatia Address Generator - Generate Real Croatian Addresses, Identity Info & Contact Details Online",
  "description": "Free online Croatia address generator that creates real-format Croatian addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
