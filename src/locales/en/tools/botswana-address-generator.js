export default {
  "name": "Botswana Address Generator - Generate Real Botswanan Addresses, Identity Info & Contact Details Online",
  "description": "Free online Botswana address generator that creates real-format Botswanan addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
