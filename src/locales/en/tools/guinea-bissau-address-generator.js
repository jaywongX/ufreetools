export default {
  "name": "Guinea-Bissau Address Generator - Generate Real Bissau-Guinean Addresses, Identity Info & Contact Details Online",
  "description": "Free online Guinea-Bissau address generator that creates real-format Bissau-Guinean addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
  ...
  "idCardTitle": "Guinea-Bissau Test ID",
