export default {
  "name": "Serbia Address Generator - Generate Real Serbian Addresses, Identity Info & Contact Details Online",
  "description": "Free online Serbia address generator that creates real-format Serbian addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
