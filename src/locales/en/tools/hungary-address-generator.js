export default {
  "name": "Hungary Address Generator - Generate Real Hungarian Addresses, Identity Info & Contact Details Online",
  "description": "Free online Hungary address generator that creates real-format Hungarian addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
