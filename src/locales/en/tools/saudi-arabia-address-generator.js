export default {
  "name": "Saudi Arabia Address Generator - Generate Real Saudi Arabian Addresses, Identity Info & Contact Details Online",
  "description": "Free online Saudi Arabia address generator that creates real-format Saudi Arabian addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
  ...
  "idCardTitle": "Saudi Arabia Test ID",
