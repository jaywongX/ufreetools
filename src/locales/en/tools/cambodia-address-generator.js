export default {
  "name": "Cambodia Address Generator - Generate Real Cambodian Addresses, Identity Info & Contact Details Online",
  "description": "Free online Cambodia address generator that creates real-format Cambodian addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
