export default {
  "name": "Cyprus Address Generator - Generate Real Cypriot Addresses, Identity Info & Contact Details Online",
  "description": "Free online Cyprus address generator that creates real-format Cypriot addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
