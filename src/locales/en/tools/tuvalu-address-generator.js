export default {
  "name": "Tuvalu Address Generator - Generate Real Tuvaluan Addresses, Identity Info & Contact Details Online",
  "description": "Free online Tuvalu address generator that creates real-format Tuvaluan addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
