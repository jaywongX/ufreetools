export default {
  "name": "Austria Address Generator - Generate Real Austrian Addresses, Identity Info & Contact Details Online",
  "description": "Free online Austria address generator that creates real-format Austrian addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
