export default {
  "name": "Marshall Islands Address Generator - Generate Real Marshallese Addresses, Identity Info & Contact Details Online",
  "description": "Free online Marshall Islands address generator that creates real-format Marshallese addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
  ...
  "idCardTitle": "Marshall Islands Test ID",
