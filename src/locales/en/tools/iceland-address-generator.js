export default {
  "name": "Iceland Address Generator - Generate Real Icelandic Addresses, Identity Info & Contact Details Online",
  "description": "Free online Iceland address generator that creates real-format Icelandic addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
