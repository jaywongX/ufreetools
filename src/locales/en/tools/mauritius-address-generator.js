export default {
  "name": "Mauritius Address Generator - Generate Real Mauritian Addresses, Identity Info & Contact Details Online",
  "description": "Free online Mauritius address generator that creates real-format Mauritian addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
