export default {
  "name": "Ghana Address Generator - Generate Real Ghanaian Addresses, Identity Info & Contact Details Online",
  "description": "Free online Ghana address generator that creates real-format Ghanaian addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
