export default {
  "name": "Slovenia Address Generator - Generate Real Slovenian Addresses, Identity Info & Contact Details Online",
  "description": "Free online Slovenia address generator that creates real-format Slovenian addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
