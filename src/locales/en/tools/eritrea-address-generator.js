export default {
  "name": "Eritrea Address Generator - Generate Real Eritrean Addresses, Identity Info & Contact Details Online",
  "description": "Free online Eritrea address generator that creates real-format Eritrean addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
