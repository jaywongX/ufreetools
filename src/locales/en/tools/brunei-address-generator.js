export default {
  "name": "Brunei Address Generator - Generate Real Bruneian Addresses, Identity Info & Contact Details Online",
  "description": "Free online Brunei address generator that creates real-format Bruneian addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
