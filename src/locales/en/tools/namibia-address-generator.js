export default {
  "name": "Namibia Address Generator - Generate Real Namibian Addresses, Identity Info & Contact Details Online",
  "description": "Free online Namibia address generator that creates real-format Namibian addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
