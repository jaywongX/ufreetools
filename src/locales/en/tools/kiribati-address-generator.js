export default {
  "name": "Kiribati Address Generator - Generate Real I-Kiribati Addresses, Identity Info & Contact Details Online",
  "description": "Free online Kiribati address generator that creates real-format I-Kiribati addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
