export default {
  "name": "Niger Address Generator - Generate Real Nigerien Addresses, Identity Info & Contact Details Online",
  "description": "Free online Niger address generator that creates real-format Nigerien addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
