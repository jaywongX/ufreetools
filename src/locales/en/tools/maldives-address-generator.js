export default {
  "name": "Maldives Address Generator - Generate Real Maldivian Addresses, Identity Info & Contact Details Online",
  "description": "Free online Maldives address generator that creates real-format Maldivian addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
