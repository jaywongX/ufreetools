export default {
  "name": "Togo Address Generator - Generate Real Togolese Addresses, Identity Info & Contact Details Online",
  "description": "Free online Togo address generator that creates real-format Togolese addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
