export default {
  "name": "Mongolia Address Generator - Generate Real Mongolian Addresses, Identity Info & Contact Details Online",
  "description": "Free online Mongolia address generator that creates real-format Mongolian addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
