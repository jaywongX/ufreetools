export default {
  "name": "Cuba Address Generator - Generate Real Cuban Addresses, Identity Info & Contact Details Online",
  "description": "Free online Cuba address generator that creates real-format Cuban addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
