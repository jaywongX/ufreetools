export default {
  "name": "Indonesia Address Generator - Generate Real Indonesian Addresses, Identity Info & Contact Details Online",
  "description": "Free online Indonesia address generator that creates real-format Indonesian addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
