export default {
  ...
  article: {
    ...
    guide: {
      ...
      steps: [
        "<strong>Enter your Markdown text</strong>: Begin by typing or pasting your Markdown content into the input area on the left side of the converter. If you're new to Markdown or need a starting point, use the 'Load Sample' button to see examples of basic syntax, extended features, or a complete article structure.",
        "<strong>Select conversion options</strong>: Configure your conversion preferences using the options at the top of the tool. You can enable 'Realtime Preview' to see changes instantly, 'Scroll Sync' to keep input and output areas scrolled together, 'Sanitize HTML' to remove potentially unsafe elements, and 'Include Default CSS' to add basic styling to your HTML output.",
        "<strong>Preview your content</strong>: As you type or after pasting content, the preview area on the right will show how your Markdown will look when rendered as HTML. Toggle between 'Preview' mode to see the formatted result and 'HTML Code' mode to view the actual HTML markup that's being generated.",
        "<strong>Refine your Markdown</strong>: Make any necessary adjustments to your Markdown text, referring to the preview to ensure your formatting appears as intended. The converter updates in real-time (if enabled), letting you see the impact of your changes immediately.",
        "<strong>Format code blocks</strong>: For technical content, use triple backticks (```) followed by a language name to create syntax-highlighted code blocks. For example, use ```javascript before your code and ``` after it to properly format JavaScript code with syntax highlighting.",
        "<strong>Copy the generated HTML</strong>: Once you're satisfied with the conversion, click the 'Copy HTML' button (the upward arrow icon) above the output area to copy the HTML code to your clipboard. You can then paste it into your website editor, CMS, or any application that accepts HTML.",
        "<strong>Download as HTML file</strong>: If you need to save the complete HTML document, click the 'Download HTML' button (the download icon) to save the conversion result as an HTML file that can be opened in any web browser."
      ]
    },
