export default {
  "name": "Laos Address Generator - Generate Real Lao Addresses, Identity Info & Contact Details Online",
  "description": "Free online Laos address generator that creates real-format Lao addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
