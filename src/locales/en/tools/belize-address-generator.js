export default {
  "name": "Belize Address Generator - Generate Real Belizean Addresses, Identity Info & Contact Details Online",
  "description": "Free online Belize address generator that creates real-format Belizean addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
