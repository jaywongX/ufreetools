export default {
  "name": "Cape Verde Address Generator - Generate Real Cabo Verdean Addresses, Identity Info & Contact Details Online",
  "description": "Free online Cape Verde address generator that creates real-format Cabo Verdean addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
  ...
  "idCardTitle": "Cabo Verde Test ID",
