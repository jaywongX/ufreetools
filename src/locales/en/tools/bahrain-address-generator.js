export default {
  "name": "Bahrain Address Generator - Generate Real Bahraini Addresses, Identity Info & Contact Details Online",
  "description": "Free online Bahrain address generator that creates real-format Bahraini addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
