export default {
  "name": "Romania Address Generator - Generate Real Romanian Addresses, Identity Info & Contact Details Online",
  "description": "Free online Romania address generator that creates real-format Romanian addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
