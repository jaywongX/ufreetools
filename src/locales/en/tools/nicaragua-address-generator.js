export default {
  "name": "Nicaragua Address Generator - Generate Real Nicaraguan Addresses, Identity Info & Contact Details Online",
  "description": "Free online Nicaragua address generator that creates real-format Nicaraguan addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
