export default {
  "name": "São Tomé & Príncipe Address Generator - Generate Real Sao Tomean Addresses, Identity Info & Contact Details Online",
  "description": "Free online São Tomé & Príncipe address generator that creates real-format Sao Tomean addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
  ...
  "idCardTitle": "Sao Tome and Principe Test ID",
