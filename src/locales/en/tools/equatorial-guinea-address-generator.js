export default {
  "name": "Equatorial Guinea Address Generator - Generate Real Equatoguinean Addresses, Identity Info & Contact Details Online",
  "description": "Free online Equatorial Guinea address generator that creates real-format Equatoguinean addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
  ...
  "idCardTitle": "Equatorial Guinea Test ID",
