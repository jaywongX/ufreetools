export default {
  "name": "Cameroon Address Generator - Generate Real Cameroonian Addresses, Identity Info & Contact Details Online",
  "description": "Free online Cameroon address generator that creates real-format Cameroonian addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
