export default {
  "name": "Kyrgyzstan Address Generator - Generate Real Kyrgyz Addresses, Identity Info & Contact Details Online",
  "description": "Free online Kyrgyzstan address generator that creates real-format Kyrgyz addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
  ...
  "idCardTitle": "Kyrgyzstan Test ID",
