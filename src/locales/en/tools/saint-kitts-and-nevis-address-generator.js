export default {
  "name": "St. Kitts & Nevis Address Generator - Generate Real Kittitian and Nevisian Addresses, Identity Info & Contact Details Online",
  "description": "Free online St. Kitts & Nevis address generator that creates real-format Kittitian and Nevisian addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
  ...
  "idCardTitle": "Saint Kitts and Nevis Test ID",
