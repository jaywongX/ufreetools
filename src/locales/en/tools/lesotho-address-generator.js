export default {
  "name": "Lesotho Address Generator - Generate Real Basotho Addresses, Identity Info & Contact Details Online",
  "description": "Free online Lesotho address generator that creates real-format Basotho addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
