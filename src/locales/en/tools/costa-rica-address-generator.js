export default {
  "name": "Costa Rica Address Generator - Generate Real Costa Rican Addresses, Identity Info & Contact Details Online",
  "description": "Free online Costa Rica address generator that creates real-format Costa Rican addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
  ...
  "idCardTitle": "Costa Rica Test ID",
