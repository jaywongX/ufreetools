export default {
  "name": "Portugal Address Generator - Generate Real Portuguese Addresses, Identity Info & Contact Details Online",
  "description": "Free online Portugal address generator that creates real-format Portuguese addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
