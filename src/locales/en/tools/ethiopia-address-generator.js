export default {
  "name": "Ethiopia Address Generator - Generate Real Ethiopian Addresses, Identity Info & Contact Details Online",
  "description": "Free online Ethiopia address generator that creates real-format Ethiopian addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
