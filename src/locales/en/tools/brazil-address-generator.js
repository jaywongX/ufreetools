export default {
  "name": "Brazil Address Generator - Generate Real Brazilian Addresses, Identity Info & Contact Details Online",
  "description": "Free online Brazil address generator that creates real-format Brazilian addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
