export default {
  "name": "Dominica Address Generator - Generate Real Dominican Addresses, Identity Info & Contact Details Online",
  "description": "Free online Dominica address generator that creates real-format Dominican addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
