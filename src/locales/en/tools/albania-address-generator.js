export default {
  "name": "Albania Address Generator - Generate Real Albanian Addresses, Identity Info & Contact Details Online",
  "description": "Free online Albania address generator that creates real-format Albanian addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
