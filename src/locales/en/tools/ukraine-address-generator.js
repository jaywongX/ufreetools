export default {
  "name": "Ukraine Address Generator - Generate Real Ukrainian Addresses, Identity Info & Contact Details Online",
  "description": "Free online Ukraine address generator that creates real-format Ukrainian addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
