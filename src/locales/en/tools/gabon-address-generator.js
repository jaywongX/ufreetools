export default {
  "name": "Gabon Address Generator - Generate Real Gabonese Addresses, Identity Info & Contact Details Online",
  "description": "Free online Gabon address generator that creates real-format Gabonese addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
