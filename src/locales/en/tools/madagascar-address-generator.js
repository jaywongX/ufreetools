export default {
  "name": "Madagascar Address Generator - Generate Real Malagasy Addresses, Identity Info & Contact Details Online",
  "description": "Free online Madagascar address generator that creates real-format Malagasy addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
  ...
  "idCardTitle": "Madagascar Test ID",
