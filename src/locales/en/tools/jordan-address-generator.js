export default {
  "name": "Jordan Address Generator - Generate Real Jordanian Addresses, Identity Info & Contact Details Online",
  "description": "Free online Jordan address generator that creates real-format Jordanian addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
