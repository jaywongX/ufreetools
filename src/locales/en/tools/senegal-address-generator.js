export default {
  "name": "Senegal Address Generator - Generate Real Senegalese Addresses, Identity Info & Contact Details Online",
  "description": "Free online Senegal address generator that creates real-format Senegalese addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
