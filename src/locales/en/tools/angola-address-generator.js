export default {
  "name": "Angola Address Generator - Generate Real Angolan Addresses, Identity Info & Contact Details Online",
  "description": "Free online Angola address generator that creates real-format Angolan addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
