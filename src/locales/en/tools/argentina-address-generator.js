export default {
  "name": "Argentina Address Generator - Generate Real Argentine Addresses, Identity Info & Contact Details Online",
  "description": "Free online Argentina address generator that creates real-format Argentine addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
