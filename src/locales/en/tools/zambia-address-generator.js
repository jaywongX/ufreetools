export default {
  "name": "Zambia Address Generator - Generate Real Zambian Addresses, Identity Info & Contact Details Online",
  "description": "Free online Zambia address generator that creates real-format Zambian addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
