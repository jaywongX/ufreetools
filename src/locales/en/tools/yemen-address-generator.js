export default {
  "name": "Yemen Address Generator - Generate Real Yemeni Addresses, Identity Info & Contact Details Online",
  "description": "Free online Yemen address generator that creates real-format Yemeni addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
