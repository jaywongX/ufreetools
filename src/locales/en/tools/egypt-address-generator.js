export default {
  "name": "Egypt Address Generator - Generate Real Egyptian Addresses, Identity Info & Contact Details Online",
  "description": "Free online Egypt address generator that creates real-format Egyptian addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
