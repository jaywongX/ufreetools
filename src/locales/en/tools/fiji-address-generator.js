export default {
  "name": "Fiji Address Generator - Generate Real Fijian Addresses, Identity Info & Contact Details Online",
  "description": "Free online Fiji address generator that creates real-format Fijian addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
