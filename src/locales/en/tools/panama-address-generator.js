export default {
  "name": "Panama Address Generator - Generate Real Panamanian Addresses, Identity Info & Contact Details Online",
  "description": "Free online Panama address generator that creates real-format Panamanian addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
