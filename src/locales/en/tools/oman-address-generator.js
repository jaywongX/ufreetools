export default {
  "name": "Oman Address Generator - Generate Real Omani Addresses, Identity Info & Contact Details Online",
  "description": "Free online Oman address generator that creates real-format Omani addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
