export default {
  "name": "Timor-Leste Address Generator - Generate Real Timorese Addresses, Identity Info & Contact Details Online",
  "description": "Free online Timor-Leste address generator that creates real-format Timorese addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
  ...
  "idCardTitle": "Timor-Leste Test ID",
