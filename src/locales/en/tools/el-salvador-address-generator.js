export default {
  "name": "El Salvador Address Generator - Generate Real Salvadoran Addresses, Identity Info & Contact Details Online",
  "description": "Free online El Salvador address generator that creates real-format Salvadoran addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
  ...
  "idCardTitle": "El Salvador Test ID",
