export default {
  "name": "Monaco Address Generator - Generate Real Monégasque Addresses, Identity Info & Contact Details Online",
  "description": "Free online Monaco address generator that creates real-format Monégasque addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
