export default {
  "name": "Libya Address Generator - Generate Real Libyan Addresses, Identity Info & Contact Details Online",
  "description": "Free online Libya address generator that creates real-format Libyan addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
