export default {
  "name": "Palau Address Generator - Generate Real Palauan Addresses, Identity Info & Contact Details Online",
  "description": "Free online Palau address generator that creates real-format Palauan addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
