export default {
  "name": "Jamaica Address Generator - Generate Real Jamaican Addresses, Identity Info & Contact Details Online",
  "description": "Free online Jamaica address generator that creates real-format Jamaican addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
