export default {
  "name": "Nauru Address Generator - Generate Real Nauruan Addresses, Identity Info & Contact Details Online",
  "description": "Free online Nauru address generator that creates real-format Nauruan addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
