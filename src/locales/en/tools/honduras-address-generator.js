export default {
  "name": "Honduras Address Generator - Generate Real Honduran Addresses, Identity Info & Contact Details Online",
  "description": "Free online Honduras address generator that creates real-format Honduran addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
