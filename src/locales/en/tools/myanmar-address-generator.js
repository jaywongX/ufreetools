export default {
  "name": "Myanmar (Burma) Address Generator - Generate Real Myanmar Addresses, Identity Info & Contact Details Online",
  "description": "Free online Myanmar (Burma) address generator that creates real-format Myanmar addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
