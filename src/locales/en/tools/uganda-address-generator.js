export default {
  "name": "Uganda Address Generator - Generate Real Ugandan Addresses, Identity Info & Contact Details Online",
  "description": "Free online Uganda address generator that creates real-format Ugandan addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
