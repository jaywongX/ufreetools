export default {
  "name": "Gambia Address Generator - Generate Real Gambian Addresses, Identity Info & Contact Details Online",
  "description": "Free online Gambia address generator that creates real-format Gambian addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
