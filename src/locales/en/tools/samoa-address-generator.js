export default {
  "name": "Samoa Address Generator - Generate Real Samoan Addresses, Identity Info & Contact Details Online",
  "description": "Free online Samoa address generator that creates real-format Samoan addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
