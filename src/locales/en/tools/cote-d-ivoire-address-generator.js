export default {
  "name": "Côte d’Ivoire Address Generator - Generate Real Ivorian Addresses, Identity Info & Contact Details Online",
  "description": "Free online Côte d’Ivoire address generator that creates real-format Ivorian addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
  ...
  "idCardTitle": "Cote d'Ivoire Test ID",
