export default {
  "name": "Papua New Guinea Address Generator - Generate Real Papua New Guinean Addresses, Identity Info & Contact Details Online",
  "description": "Free online Papua New Guinea address generator that creates real-format Papua New Guinean addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
  ...
  "idCardTitle": "Papua New Guinea Test ID",
