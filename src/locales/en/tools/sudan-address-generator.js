export default {
  "name": "Sudan Address Generator - Generate Real Sudanese Addresses, Identity Info & Contact Details Online",
  "description": "Free online Sudan address generator that creates real-format Sudanese addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
