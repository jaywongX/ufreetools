export default {
  "name": "Grenada Address Generator - Generate Real Grenadian Addresses, Identity Info & Contact Details Online",
  "description": "Free online Grenada address generator that creates real-format Grenadian addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
