export default {
  "name": "Nepal Address Generator - Generate Real Nepalese Addresses, Identity Info & Contact Details Online",
  "description": "Free online Nepal address generator that creates real-format Nepalese addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
