export default {
  "name": "Venezuela Address Generator - Generate Real Venezuelan Addresses, Identity Info & Contact Details Online",
  "description": "Free online Venezuela address generator that creates real-format Venezuelan addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
