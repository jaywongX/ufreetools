export default {
  "name": "Djibouti Address Generator - Generate Real Djiboutian Addresses, Identity Info & Contact Details Online",
  "description": "Free online Djibouti address generator that creates real-format Djiboutian addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
