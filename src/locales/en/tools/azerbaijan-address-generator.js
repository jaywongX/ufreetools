export default {
  "name": "Azerbaijan Address Generator - Generate Real Azerbaijani Addresses, Identity Info & Contact Details Online",
  "description": "Free online Azerbaijan address generator that creates real-format Azerbaijani addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
  ...
  "idCardTitle": "Azerbaijan Test ID",
