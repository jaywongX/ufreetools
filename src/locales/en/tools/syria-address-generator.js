export default {
  "name": "Syria Address Generator - Generate Real Syrian Addresses, Identity Info & Contact Details Online",
  "description": "Free online Syria address generator that creates real-format Syrian addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
