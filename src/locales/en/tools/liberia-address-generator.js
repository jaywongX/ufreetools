export default {
  "name": "Liberia Address Generator - Generate Real Liberian Addresses, Identity Info & Contact Details Online",
  "description": "Free online Liberia address generator that creates real-format Liberian addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
