export default {
  "name": "Ireland Address Generator - Generate Real Irish Addresses, Identity Info & Contact Details Online",
  "description": "Free online Ireland address generator that creates real-format Irish addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
