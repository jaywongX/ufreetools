export default {
  "name": "Haiti Address Generator - Generate Real Haitian Addresses, Identity Info & Contact Details Online",
  "description": "Free online Haiti address generator that creates real-format Haitian addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
