export default {
  "name": "Sri Lanka Address Generator - Generate Real Sri Lankan Addresses, Identity Info & Contact Details Online",
  "description": "Free online Sri Lanka address generator that creates real-format Sri Lankan addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
