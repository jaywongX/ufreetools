export default {
  "name": "Kenya Address Generator - Generate Real Kenyan Addresses, Identity Info & Contact Details Online",
  "description": "Free online Kenya address generator that creates real-format Kenyan addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
