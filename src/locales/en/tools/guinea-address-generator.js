export default {
  "name": "Guinea Address Generator - Generate Real Guinean Addresses, Identity Info & Contact Details Online",
  "description": "Free online Guinea address generator that creates real-format Guinean addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
