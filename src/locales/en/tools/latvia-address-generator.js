export default {
  "name": "Latvia Address Generator - Generate Real Latvian Addresses, Identity Info & Contact Details Online",
  "description": "Free online Latvia address generator that creates real-format Latvian addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
