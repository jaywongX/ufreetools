export default {
  "name": "Qatar Address Generator - Generate Real Qatari Addresses, Identity Info & Contact Details Online",
  "description": "Free online Qatar address generator that creates real-format Qatari addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
