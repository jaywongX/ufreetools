export default {
  "name": "Norway Address Generator - Generate Real Norwegian Addresses, Identity Info & Contact Details Online",
  "description": "Free online Norway address generator that creates real-format Norwegian addresses, ID numbers, phone numbers, credit card numbers and complete identity profiles. Supports province filtering, JSON/CSV export formats, and runs entirely in the browser for privacy protection.",
