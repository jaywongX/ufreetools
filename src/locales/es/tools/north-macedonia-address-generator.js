export default {
  "name": "Generador de Direcciones de Macedonia del Norte - Genere direcciones reales Macedonia del Norte, información de identidad y datos de contacto en línea",
  "description": "Generador gratuito en línea de direcciones Macedonia del Norte que crea direcciones de formato real Macedonia del Norte, números de identificación, números de teléfono, números de tarjetas de crédito y perfiles completos de identidad. Soporta filtrado por provincia, exportación en formatos JSON/CSV y se ejecuta completamente en el navegador para proteger la privacidad.",
