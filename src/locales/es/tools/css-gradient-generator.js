    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          answer: "Usar el código de gradiente de nuestra herramienta es sencillo: 1) Cree y personalice su gradiente usando los controles visuales. 2) Haga clic en el botón 'Copiar Código' para copiar el CSS generado a su portapapeles. 3) Pegue el código en su archivo CSS o sección de estilo de su documento HTML. El código puede aplicarse a cualquier propiedad CSS que acepte valores de imagen, siendo la más común la propiedad 'background'.  También puede modificar el código copiado para agregar propiedades adicionales, cambiar el selector o combinarlo con otras reglas CSS. Si necesita el gradiente como imagen, use la función 'Descargar PNG' para guardarla como un archivo que se pueda importar en cualquier aplicación que acepte imágenes PNG."
        },
        {
