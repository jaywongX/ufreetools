export default {
  "name": "Generador de Direcciones de Santa Lucía - Genere direcciones reales Santa Lucía, información de identidad y datos de contacto en línea",
  "description": "Generador gratuito en línea de direcciones Santa Lucía que crea direcciones de formato real Santa Lucía, números de identificación, números de teléfono, números de tarjetas de crédito y perfiles completos de identidad. Soporta filtrado por provincia, exportación en formatos JSON/CSV y se ejecuta completamente en el navegador para proteger la privacidad.",
