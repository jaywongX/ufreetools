export default {
  "name": "Generador de Direcciones de Mauritania - Genere direcciones reales Mauritania, información de identidad y datos de contacto en línea",
  "description": "Generador gratuito en línea de direcciones Mauritania que crea direcciones de formato real Mauritania, números de identificación, números de teléfono, números de tarjetas de crédito y perfiles completos de identidad. Soporta filtrado por provincia, exportación en formatos JSON/CSV y se ejecuta completamente en el navegador para proteger la privacidad.",
