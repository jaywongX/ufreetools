export default {
  "name": "Generador de Direcciones de Tayikistán - Genere direcciones reales Tayikistán, información de identidad y datos de contacto en línea",
  "description": "Generador gratuito en línea de direcciones Tayikistán que crea direcciones de formato real Tayikistán, números de identificación, números de teléfono, números de tarjetas de crédito y perfiles completos de identidad. Soporta filtrado por provincia, exportación en formatos JSON/CSV y se ejecuta completamente en el navegador para proteger la privacidad.",
