export default {
  "name": "Generador de Direcciones de Santo Tomé y Príncipe - Genere direcciones reales Santo Tomé y Príncipe, información de identidad y datos de contacto en línea",
  "description": "Generador gratuito en línea de direcciones Santo Tomé y Príncipe que crea direcciones de formato real Santo Tomé y Príncipe, números de identificación, números de teléfono, números de tarjetas de crédito y perfiles completos de identidad. Soporta filtrado por provincia, exportación en formatos JSON/CSV y se ejecuta completamente en el navegador para proteger la privacidad.",
