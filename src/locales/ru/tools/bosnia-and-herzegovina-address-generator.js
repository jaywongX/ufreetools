export default {
  "name": "Генератор адресов Боснии и Герцеговины - Генерация реальных Боснии и Герцеговины адресов, данных идентификации и контактной информации онлайн",
  "description": "Бесплатный онлайн-генератор адресов Боснии и Герцеговины, который создает реальные Боснии и Герцеговины адреса, номера удостоверений личности, номера телефонов, номера кредитных карт и полные профили идентификации. Поддерживает фильтрацию по провинциям, форматы экспорта JSON/CSV и работает полностью в браузере для защиты конфиденциальности.",
