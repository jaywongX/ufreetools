export default {
  "name": "Генератор адресов Папуа — Новая Гвинея - Генерация реальных Папуа — Новая Гвинея адресов, данных идентификации и контактной информации онлайн",
  "description": "Бесплатный онлайн-генератор адресов Папуа — Новая Гвинея, который создает реальные Папуа — Новая Гвинея адреса, номера удостоверений личности, номера телефонов, номера кредитных карт и полные профили идентификации. Поддерживает фильтрацию по провинциям, форматы экспорта JSON/CSV и работает полностью в браузере для защиты конфиденциальности.",
