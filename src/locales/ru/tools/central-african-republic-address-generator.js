export default {
  "name": "Генератор адресов Центрально-Африканская Республика - Генерация реальных Центрально-Африканская Республика адресов, данных идентификации и контактной информации онлайн",
  "description": "Бесплатный онлайн-генератор адресов Центрально-Африканская Республика, который создает реальные Центрально-Африканская Республика адреса, номера удостоверений личности, номера телефонов, номера кредитных карт и полные профили идентификации. Поддерживает фильтрацию по провинциям, форматы экспорта JSON/CSV и работает полностью в браузере для защиты конфиденциальности.",
  ...
  "turkey": "Центрально-Африканская Республика",
