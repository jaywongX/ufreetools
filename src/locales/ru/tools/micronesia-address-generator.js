export default {
  "name": "Генератор адресов Федеративные Штаты Микронезии - Генерация реальных Федеративные Штаты Микронезии адресов, данных идентификации и контактной информации онлайн",
  "description": "Бесплатный онлайн-генератор адресов Федеративные Штаты Микронезии, который создает реальные Федеративные Штаты Микронезии адреса, номера удостоверений личности, номера телефонов, номера кредитных карт и полные профили идентификации. Поддерживает фильтрацию по провинциям, форматы экспорта JSON/CSV и работает полностью в браузере для защиты конфиденциальности.",
  ...
  "turkey": "Федеративные Штаты Микронезии",
