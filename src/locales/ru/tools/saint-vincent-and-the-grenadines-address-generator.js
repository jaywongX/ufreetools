export default {
  "name": "Генератор адресов Сент-Винсент и Гренадины - Генерация реальных Сент-Винсент и Гренадины адресов, данных идентификации и контактной информации онлайн",
  "description": "Бесплатный онлайн-генератор адресов Сент-Винсент и Гренадины, который создает реальные Сент-Винсент и Гренадины адреса, номера удостоверений личности, номера телефонов, номера кредитных карт и полные профили идентификации. Поддерживает фильтрацию по провинциям, форматы экспорта JSON/CSV и работает полностью в браузере для защиты конфиденциальности.",
  ...
  "turkey": "Сент-Винсент и Гренадины",
