export default {
  "name": "Генератор адресов Тринидад и Тобаго - Генерация реальных Тринидад и Тобаго адресов, данных идентификации и контактной информации онлайн",
  "description": "Бесплатный онлайн-генератор адресов Тринидад и Тобаго, который создает реальные Тринидад и Тобаго адреса, номера удостоверений личности, номера телефонов, номера кредитных карт и полные профили идентификации. Поддерживает фильтрацию по провинциям, форматы экспорта JSON/CSV и работает полностью в браузере для защиты конфиденциальности.",
