export default {
  "name": "Генератор адресов Конго - Браззавиль - Генерация реальных Конго - Браззавиль адресов, данных идентификации и контактной информации онлайн",
  "description": "Бесплатный онлайн-генератор адресов Конго - Браззавиль, который создает реальные Конго - Браззавиль адреса, номера удостоверений личности, номера телефонов, номера кредитных карт и полные профили идентификации. Поддерживает фильтрацию по провинциям, форматы экспорта JSON/CSV и работает полностью в браузере для защиты конфиденциальности.",
