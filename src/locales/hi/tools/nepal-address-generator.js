export default {
  "name": "नेपाल पता जनरेटर - वास्तविक नेपाल पते, पहचान जानकारी और संपर्क विवरण ऑनलाइन जनरेट करें",
  "description": "मुफ़्त ऑनलाइन नेपाल पता जनरेटर जो वास्तविक प्रारूप के नेपाल पते, आईडी नंबर, फ़ोन नंबर, क्रेडिट कार्ड नंबर और पूर्ण पहचान प्रोफ़ाइल बनाता है। प्रांत फ़िल्टरिंग, JSON/CSV निर्यात प्रारूपों का समर्थन करता है और गोपनीयता सुरक्षा के लिए पूरी तरह से ब्राउज़र में चलता है।",
  ...
  "provinces": {
    "BAG": "Bagmati Province",
    "GAN": "Gandaki Province",
    "LUM": "Lumbini Province"
  },
  "districtsData": {
    "BAG": {
      "kathmandu": "Kathmandu",
  ...
  "universities": {
    "U1": "Tribhuvan University",
    "U2": "Kathmandu University",
    "U3": "Pokhara University"
  },
  "csv": {
