export default {
  "name": "सेंट लूसिया पता जनरेटर - वास्तविक सेंट लूसिया पते, पहचान जानकारी और संपर्क विवरण ऑनलाइन जनरेट करें",
  "description": "मुफ़्त ऑनलाइन सेंट लूसिया पता जनरेटर जो वास्तविक प्रारूप के सेंट लूसिया पते, आईडी नंबर, फ़ोन नंबर, क्रेडिट कार्ड नंबर और पूर्ण पहचान प्रोफ़ाइल बनाता है। प्रांत फ़िल्टरिंग, JSON/CSV निर्यात प्रारूपों का समर्थन करता है और गोपनीयता सुरक्षा के लिए पूरी तरह से ब्राउज़र में चलता है।",
  ...
  "idCardTitle": "सेंट लूसिया आईडी कार्ड",
  ...
  "districtsData": {
    ...
    "GR": {
      "gros_islet": "Gros Islet",
      "rodney_bay": "Rodney Bay",
      "cap_estate": "Cap Estate"
    },
    "VF": {
      "vieux_fort": "Vieux Fort",
      "laborie": "Laborie",
      "augier": "Augier"
    }
  },
  "universities": {
    "U1": "Sir Arthur Lewis Community College",
    "U2": "University of the West Indies Open Campus",
    "U3": "International American University"
  },
  "csv": {
