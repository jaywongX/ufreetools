export default {
  "name": "यमन पता जनरेटर - वास्तविक यमन पते, पहचान जानकारी और संपर्क विवरण ऑनलाइन जनरेट करें",
  "description": "मुफ़्त ऑनलाइन यमन पता जनरेटर जो वास्तविक प्रारूप के यमन पते, आईडी नंबर, फ़ोन नंबर, क्रेडिट कार्ड नंबर और पूर्ण पहचान प्रोफ़ाइल बनाता है। प्रांत फ़िल्टरिंग, JSON/CSV निर्यात प्रारूपों का समर्थन करता है और गोपनीयता सुरक्षा के लिए पूरी तरह से ब्राउज़र में चलता है।",
  ...
  "provinces": {
    "SAN": "Sana’a Governorate",
    "ADE": "Aden Governorate",
    "TAI": "Taiz Governorate"
  },
  "districtsData": {
    "SAN": {
      "sana_a": "Sana’a",
      "bani_hushaysh": "Bani Hushaysh",
      "arhab": "Arhab"
    },
    "ADE": {
      "aden": "Aden",
    ...
    "TAI": {
      "taiz": "Taiz",
      "al_qahirah": "Al Qahirah",
      "salah": "Salah"
    }
  },
  "universities": {
    "U1": "Sana’a University",
    "U2": "University of Aden",
    "U3": "Taiz University"
  },
  "csv": {
