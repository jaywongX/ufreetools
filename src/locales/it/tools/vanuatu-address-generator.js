export default {
  "name": "Generatore di Indirizzi Turchi - Genera indirizzi Vanuatu reali, informazioni di identità e dettagli di contatto online",
  "description": "Generatore gratuito online di indirizzi Vanuatu che crea indirizzi Vanuatu in formato reale, numeri di identificazione, numeri di telefono, numeri di carta di credito e profili di identità completi. Supporta il filtraggio per provincia, i formati di esportazione JSON/CSV e funziona interamente nel browser per la protezione della privacy.",
