export default {
  "name": "Générateur d'adresses de Saint-Vincent-et-les Grenadines - Générez des adresses Saint-Vincent-et-les Grenadines réelles, des informations d'identité et des coordonnées en ligne",
  "description": "Générateur d'adresses de Saint-Vincent-et-les Grenadines gratuit en ligne qui crée des adresses Saint-Vincent-et-les Grenadines au format réel, des numéros d'identité, des numéros de téléphone, des numéros de cartes de crédit et des profils d'identité complets. Prend en charge le filtrage par province, les formats d'export JSON/CSV et s'exécute entièrement dans le navigateur pour la protection de la vie privée.",
  ...
  "idCardTitle": "Carte d'identité Saint-Vincent-et-les Grenadines",
  ...
  "turkey": "Saint-Vincent-et-les Grenadines",
