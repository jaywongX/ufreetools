export default {
  "name": "Générateur d'adresses de Tonga - Générez des adresses Tonga réelles, des informations d'identité et des coordonnées en ligne",
  "description": "Générateur d'adresses de Tonga gratuit en ligne qui crée des adresses Tonga au format réel, des numéros d'identité, des numéros de téléphone, des numéros de cartes de crédit et des profils d'identité complets. Prend en charge le filtrage par province, les formats d'export JSON/CSV et s'exécute entièrement dans le navigateur pour la protection de la vie privée.",
  ...
  "idCardTitle": "Carte d'identité Tonga",
