export default {
  "name": "Générateur d'adresses de Algérie - Générez des adresses Algérie réelles, des informations d'identité et des coordonnées en ligne",
  "description": "Générateur d'adresses de Algérie gratuit en ligne qui crée des adresses Algérie au format réel, des numéros d'identité, des numéros de téléphone, des numéros de cartes de crédit et des profils d'identité complets. Prend en charge le filtrage par province, les formats d'export JSON/CSV et s'exécute entièrement dans le navigateur pour la protection de la vie privée.",
  ...
  "idCardTitle": "Carte d'identité Algérie",
