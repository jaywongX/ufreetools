export default {
  "name": "コンゴ民主共和国(キンシャサ)住所ジェネレーター - 実在のコンゴ民主共和国(キンシャサ)住所、身分情報、連絡先をオンラインで生成",
  "description": "無料のオンラインコンゴ民主共和国(キンシャサ)住所ジェネレーター。実在の形式のコンゴ民主共和国(キンシャサ)住所、身分証明書番号、電話番号、クレジットカード番号、完全な身分プロフィールを作成します。都道府県フィルタリング、JSON/CSVエクスポート形式をサポートし、プライバシー保護のためにブラウザ内で完全に実行されます。",
  "inputTitle": "生成設定",
  "outputTitle": "生成結果",
  "generateBtn": "データを生成",
  ...
  "idCardTitle": "コンゴ民主共和国(キンシャサ)身分証明書",
