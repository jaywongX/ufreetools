export default {
  "name": "サウジアラビア住所ジェネレーター - 実在のサウジアラビア住所、身分情報、連絡先をオンラインで生成",
  "description": "無料のオンラインサウジアラビア住所ジェネレーター。実在の形式のサウジアラビア住所、身分証明書番号、電話番号、クレジットカード番号、完全な身分プロフィールを作成します。都道府県フィルタリング、JSON/CSVエクスポート形式をサポートし、プライバシー保護のためにブラウザ内で完全に実行されます。",
  "inputTitle": "生成設定",
  "outputTitle": "生成結果",
  "generateBtn": "データを生成",
