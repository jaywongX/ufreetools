export default {
  "name": "エスワティニ住所ジェネレーター - 実在のエスワティニ住所、身分情報、連絡先をオンラインで生成",
  "description": "無料のオンラインエスワティニ住所ジェネレーター。実在の形式のエスワティニ住所、身分証明書番号、電話番号、クレジットカード番号、完全な身分プロフィールを作成します。都道府県フィルタリング、JSON/CSVエクスポート形式をサポートし、プライバシー保護のためにブラウザ内で完全に実行されます。",
  "inputTitle": "生成設定",
  "outputTitle": "生成結果",
  "generateBtn": "データを生成",
