export default {
    name: '音频转M4A - 在线音频格式转换工具',
    description: '免费在线音频转M4A工具，支持WAV、FLAC、OGG、AAC、MP3、WMA等多种格式转换为M4A。提供比特率调节、采样率设置、批量处理功能，适合苹果设备音频转换、音频压缩等场景。',
    inputTitle: '输入音频',
    outputTitle: '转换后的M4A音频',
    dragTip: '拖放音频文件到这里或点击上传（支持批量）',
    pasteTip: '或按Ctrl+V（Cmd+V）粘贴剪贴板音频文件路径',
    supported: '支持的格式: WAV, FLAC, OGG, AAC, MP3, WMA, AMR, AIFF, APE',
    convertBtn: '转换为M4A',
    converting: '正在转换...',
    downloadBtn: '下载M4A',
    ...
    // 提示信息
    tipsTitle: '使用小贴士',
    tipContent: 'M4A格式采用AAC编码，具有出色的压缩效率和音质，特别适合苹果设备。建议根据用途选择合适比特率：语音128kbps，音乐192-256kbps，高保真320kbps。',
    ...
    seoNote: '音频转M4A工具、在线音频格式转换器、WAV转M4A、FLAC转M4A、MP3转M4A、苹果音频格式',
};
