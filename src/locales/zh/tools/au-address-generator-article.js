export default {
    ...
    useCase1: '<strong>软件开发测试：</strong>澳大利亚地址生成器为开发者提供大量符合澳洲地址格式要求的测试数据，用于表单验证、地址解析、税务号码验证等功能测试，无需手动输入真实信息。',
    useCase2: '<strong>数据库填充：</strong>澳大利亚地址生成器可批量生成数万条结构化地址数据，快速填充开发环境数据库，提高开发效率。',
    useCase3: '<strong>教育培训演示：</strong>澳大利亚地址生成器帮助教师和培训师创建示例数据，用于讲解澳洲地址格式、税号规则、邮编体系等知识，避免使用真实个人信息。',
    ...
    tipTitle: '专业使用建议',
    tipContent: '使用澳大利亚地址生成器时，建议根据实际需求选择对应的州和领地，这样生成的地址、郊区名称、邮编会更加真实可信。对于需要大量数据的场景，可以使用批量生成功能，然后导出为CSV格式便于后续处理。',
    
    conclusion: '<p>无论是软件开发、数据测试还是教育培训，<strong>澳大利亚地址生成器</strong>都能提供高质量、格式正确的澳洲地址和相关身份信息。澳大利亚地址生成器采用开源算法，确保生成的数据符合澳洲邮政标准格式，同时所有处理都在本地完成，无需担心数据泄露风险。通过澳大利亚地址生成器，你可以快速获得完整的身份档案，包括地址、联系方式、信用卡、税号、职业信息等，满足各种测试和演示需求。</p>',
    
    faqTitle: '澳大利亚地址生成器常见问题解答',
    faq1Question: '澳大利亚地址生成器生成的是真实存在的地址吗？',
    faq1Answer: '澳大利亚地址生成器生成的地址符合澳洲真实地址格式规范，包括有效的街道名称、正确的郊区和邮编匹配，但这些地址是随机组合生成的，并非真实存在的具体地址。澳大利亚地址生成器主要用于测试、开发和教育目的，不应用于任何需要真实地址的正式用途。',
    
    faq2Question: '澳大利亚地址生成器生成的税号(TFN)可以使用吗？',
    faq2Answer: '不可以。澳大利亚地址生成器生成的税号虽然格式正确，符合澳洲税号校验规则，但这些都是虚拟税号，无法用于实际税务申报。澳大利亚地址生成器生成的税号仅用于测试表单验证、数据格式检查等开发场景，不能进行真实税务操作。',
    
    faq3Question: '澳大利亚地址生成器支持哪些数据导出格式？',
    faq3Answer: '澳大利亚地址生成器支持多种导出格式：JSON格式便于程序处理，CSV格式适合Excel等表格软件打开，纯文本格式可直接复制使用。澳大利亚地址生成器支持批量导出，一次可生成并下载多条记录。',
    ...
    faq5Question: '澳大利亚地址生成器可以按特定州生成地址吗？',
    faq5Answer: '可以。澳大利亚地址生成器提供州和领地筛选功能，你可以选择特定的州或领地，系统会生成符合该地区特征的地址，包括匹配的邮编、郊区名称等。澳大利亚地址生成器支持新南威尔士州、维多利亚州、昆士兰州、西澳大利亚州、南澳大利亚州、塔斯马尼亚州、首都领地和北领地。',
    
    tutorialTitle: '澳大利亚地址生成器使用指南',
    step1Title: '步骤一：选择州/领地',
    step1Description: '在澳大利亚地址生成器中，首先选择要生成地址的州或领地。你可以选择"所有州/领地"来随机生成，也可以指定特定地区以获得更符合当地特征的地址数据。',
    step1Note: '选择特定州后，生成的地址邮编会自动匹配该州，澳洲邮编前缀对应不同的州。',
    ...
    step6Title: '步骤六：导出数据',
    step6Description: '确认数据无误后，在澳大利亚地址生成器中选择导出格式：JSON用于程序处理，CSV用于表格分析，纯文本便于直接复制。点击下载按钮即可保存到本地。',
    ...
    reference1Name: '澳大利亚邮政编码系统',
    reference1Description: '了解澳洲邮编规则和各州对应的前缀范围。',
    reference1Url: 'https://en.wikipedia.org/wiki/Postcodes_in_Australia',
    
    reference2Name: '澳洲税号(TFN)格式说明',
    reference2Description: '学习澳大利亚税务号码的格式和校验规则。',
