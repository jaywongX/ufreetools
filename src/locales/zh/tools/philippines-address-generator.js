export default {
    name: '菲律宾地址生成器 - 在线生成真实菲律宾地址、身份信息与联系方式',
    description: '免费在线菲律宾地址生成器，生成真实格式的菲律宾地址、邮编、电话、TIN/SSS身份证号、信用卡号等完整身份档案。支持按地区/城市筛选，导出JSON/CSV格式，纯前端运行保护隐私。',
    inputTitle: '生成配置',
    outputTitle: '生成结果',
    generateBtn: '生成数据',
    ...
    tinLabel: 'TIN（税务识别号）',
    sssLabel: 'SSS（社会保障号）',
    philhealthLabel: 'PhilHealth（健康保险号）',
    philsysLabel: 'PhilSys（国家身份证号）',
