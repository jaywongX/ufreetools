export default {
  "name": "厄立特里亚地址生成器 - 在线生成真实厄立特里亚地址、身份信息与联系方式",
  "description": "免费在线厄立特里亚地址生成器，生成真实格式的厄立特里亚地址、身份证号、电话、信用卡号等完整身份档案。支持按省筛选，导出JSON/CSV格式，纯前端运行保护隐私。",
  "inputTitle": "生成配置",
  "outputTitle": "生成结果",
  "generateBtn": "生成数据",
