export default {
  "name": "波士尼亞與赫塞哥維納地址生成器 - 在線生成真實波士尼亞與赫塞哥維納地址、身份信息與聯繫方式",
  "description": "免費在線波士尼亞與赫塞哥維納地址生成器，生成真實格式的波士尼亞與赫塞哥維納地址、身份證號、電話、信用卡號等完整身份檔案。支持按省篩選，導出JSON/CSV格式，純前端運行保護隱私。",
  "inputTitle": "生成配置",
  "outputTitle": "生成結果",
  "generateBtn": "生成數據",
