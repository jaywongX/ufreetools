export default {
  "name": "مولد العناوين جزر سليمان - توليد عناوين جزر سليمان حقيقية ومعلومات الهوية وبيانات الاتصال عبر الإنترنت",
  "description": "مولد عناوين جزر سليمان مجاني عبر الإنترنت ينشئ عناوين جزر سليمان بتنسيق حقيقي وأرقام الهوية وأرقام الهواتف وأرقام بطاقات الائتمان وملفات هوية كاملة. يدعم التصفية حسب المحافظة وتصدير JSON/CSV ويعمل بالكامل في المتصفح لحماية الخصوصية.",
  ...
  "idCardTitle": "البطاقة الشخصية جزر سليمان",
