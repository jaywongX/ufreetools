export default {
  "name": "مولد العناوين جزر المالديف - توليد عناوين جزر المالديف حقيقية ومعلومات الهوية وبيانات الاتصال عبر الإنترنت",
  "description": "مولد عناوين جزر المالديف مجاني عبر الإنترنت ينشئ عناوين جزر المالديف بتنسيق حقيقي وأرقام الهوية وأرقام الهواتف وأرقام بطاقات الائتمان وملفات هوية كاملة. يدعم التصفية حسب المحافظة وتصدير JSON/CSV ويعمل بالكامل في المتصفح لحماية الخصوصية.",
  ...
  "idCardTitle": "البطاقة الشخصية جزر المالديف",
