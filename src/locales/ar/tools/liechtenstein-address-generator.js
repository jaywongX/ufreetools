export default {
  "name": "مولد العناوين ليختنشتاين - توليد عناوين ليختنشتاين حقيقية ومعلومات الهوية وبيانات الاتصال عبر الإنترنت",
  "description": "مولد عناوين ليختنشتاين مجاني عبر الإنترنت ينشئ عناوين ليختنشتاين بتنسيق حقيقي وأرقام الهوية وأرقام الهواتف وأرقام بطاقات الائتمان وملفات هوية كاملة. يدعم التصفية حسب المحافظة وتصدير JSON/CSV ويعمل بالكامل في المتصفح لحماية الخصوصية.",
  ...
  "idCardTitle": "البطاقة الشخصية ليختنشتاين",
