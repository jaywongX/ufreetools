export default {
  "name": "مولد العناوين قيرغيزستان - توليد عناوين قيرغيزستان حقيقية ومعلومات الهوية وبيانات الاتصال عبر الإنترنت",
  "description": "مولد عناوين قيرغيزستان مجاني عبر الإنترنت ينشئ عناوين قيرغيزستان بتنسيق حقيقي وأرقام الهوية وأرقام الهواتف وأرقام بطاقات الائتمان وملفات هوية كاملة. يدعم التصفية حسب المحافظة وتصدير JSON/CSV ويعمل بالكامل في المتصفح لحماية الخصوصية.",
  ...
  "idCardTitle": "البطاقة الشخصية قيرغيزستان",
