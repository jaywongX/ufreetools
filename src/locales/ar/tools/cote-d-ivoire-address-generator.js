export default {
  "name": "مولد العناوين ساحل العاج - توليد عناوين ساحل العاج حقيقية ومعلومات الهوية وبيانات الاتصال عبر الإنترنت",
  "description": "مولد عناوين ساحل العاج مجاني عبر الإنترنت ينشئ عناوين ساحل العاج بتنسيق حقيقي وأرقام الهوية وأرقام الهواتف وأرقام بطاقات الائتمان وملفات هوية كاملة. يدعم التصفية حسب المحافظة وتصدير JSON/CSV ويعمل بالكامل في المتصفح لحماية الخصوصية.",
  ...
  "idCardTitle": "البطاقة الشخصية ساحل العاج",
