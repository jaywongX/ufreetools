export default {
  "name": "مولد العناوين نيوزيلندا - توليد عناوين نيوزيلندا حقيقية ومعلومات الهوية وبيانات الاتصال عبر الإنترنت",
  "description": "مولد عناوين نيوزيلندا مجاني عبر الإنترنت ينشئ عناوين نيوزيلندا بتنسيق حقيقي وأرقام الهوية وأرقام الهواتف وأرقام بطاقات الائتمان وملفات هوية كاملة. يدعم التصفية حسب المحافظة وتصدير JSON/CSV ويعمل بالكامل في المتصفح لحماية الخصوصية.",
  ...
  "idCardTitle": "البطاقة الشخصية نيوزيلندا",
