export default {
  "name": "مولد العناوين لوكسمبورغ - توليد عناوين لوكسمبورغ حقيقية ومعلومات الهوية وبيانات الاتصال عبر الإنترنت",
  "description": "مولد عناوين لوكسمبورغ مجاني عبر الإنترنت ينشئ عناوين لوكسمبورغ بتنسيق حقيقي وأرقام الهوية وأرقام الهواتف وأرقام بطاقات الائتمان وملفات هوية كاملة. يدعم التصفية حسب المحافظة وتصدير JSON/CSV ويعمل بالكامل في المتصفح لحماية الخصوصية.",
  ...
  "idCardTitle": "البطاقة الشخصية لوكسمبورغ",
