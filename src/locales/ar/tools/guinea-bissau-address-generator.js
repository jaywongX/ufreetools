export default {
  "name": "مولد العناوين غينيا بيساو - توليد عناوين غينيا بيساو حقيقية ومعلومات الهوية وبيانات الاتصال عبر الإنترنت",
  "description": "مولد عناوين غينيا بيساو مجاني عبر الإنترنت ينشئ عناوين غينيا بيساو بتنسيق حقيقي وأرقام الهوية وأرقام الهواتف وأرقام بطاقات الائتمان وملفات هوية كاملة. يدعم التصفية حسب المحافظة وتصدير JSON/CSV ويعمل بالكامل في المتصفح لحماية الخصوصية.",
  ...
  "idCardTitle": "البطاقة الشخصية غينيا بيساو",
