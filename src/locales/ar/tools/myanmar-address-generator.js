export default {
  "name": "مولد العناوين ميانمار (بورما) - توليد عناوين ميانمار (بورما) حقيقية ومعلومات الهوية وبيانات الاتصال عبر الإنترنت",
  "description": "مولد عناوين ميانمار (بورما) مجاني عبر الإنترنت ينشئ عناوين ميانمار (بورما) بتنسيق حقيقي وأرقام الهوية وأرقام الهواتف وأرقام بطاقات الائتمان وملفات هوية كاملة. يدعم التصفية حسب المحافظة وتصدير JSON/CSV ويعمل بالكامل في المتصفح لحماية الخصوصية.",
  ...
  "idCardTitle": "البطاقة الشخصية ميانمار (بورما)",
