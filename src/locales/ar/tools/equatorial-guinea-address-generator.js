export default {
  "name": "مولد العناوين غينيا الاستوائية - توليد عناوين غينيا الاستوائية حقيقية ومعلومات الهوية وبيانات الاتصال عبر الإنترنت",
  "description": "مولد عناوين غينيا الاستوائية مجاني عبر الإنترنت ينشئ عناوين غينيا الاستوائية بتنسيق حقيقي وأرقام الهوية وأرقام الهواتف وأرقام بطاقات الائتمان وملفات هوية كاملة. يدعم التصفية حسب المحافظة وتصدير JSON/CSV ويعمل بالكامل في المتصفح لحماية الخصوصية.",
  ...
  "idCardTitle": "البطاقة الشخصية غينيا الاستوائية",
