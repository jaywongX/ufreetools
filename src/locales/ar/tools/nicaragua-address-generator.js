export default {
  "name": "مولد العناوين نيكاراغوا - توليد عناوين نيكاراغوا حقيقية ومعلومات الهوية وبيانات الاتصال عبر الإنترنت",
  "description": "مولد عناوين نيكاراغوا مجاني عبر الإنترنت ينشئ عناوين نيكاراغوا بتنسيق حقيقي وأرقام الهوية وأرقام الهواتف وأرقام بطاقات الائتمان وملفات هوية كاملة. يدعم التصفية حسب المحافظة وتصدير JSON/CSV ويعمل بالكامل في المتصفح لحماية الخصوصية.",
  ...
  "idCardTitle": "البطاقة الشخصية نيكاراغوا",
