export default {
  "name": "مولد العناوين جزر البهاما - توليد عناوين جزر البهاما حقيقية ومعلومات الهوية وبيانات الاتصال عبر الإنترنت",
  "description": "مولد عناوين جزر البهاما مجاني عبر الإنترنت ينشئ عناوين جزر البهاما بتنسيق حقيقي وأرقام الهوية وأرقام الهواتف وأرقام بطاقات الائتمان وملفات هوية كاملة. يدعم التصفية حسب المحافظة وتصدير JSON/CSV ويعمل بالكامل في المتصفح لحماية الخصوصية.",
  ...
  "idCardTitle": "البطاقة الشخصية جزر البهاما",
