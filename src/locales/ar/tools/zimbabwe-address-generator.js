export default {
  "name": "مولد العناوين زيمبابوي - توليد عناوين زيمبابوي حقيقية ومعلومات الهوية وبيانات الاتصال عبر الإنترنت",
  "description": "مولد عناوين زيمبابوي مجاني عبر الإنترنت ينشئ عناوين زيمبابوي بتنسيق حقيقي وأرقام الهوية وأرقام الهواتف وأرقام بطاقات الائتمان وملفات هوية كاملة. يدعم التصفية حسب المحافظة وتصدير JSON/CSV ويعمل بالكامل في المتصفح لحماية الخصوصية.",
  ...
  "idCardTitle": "البطاقة الشخصية زيمبابوي",
