export default {
  "name": "مولد العناوين بنغلاديش - توليد عناوين بنغلاديش حقيقية ومعلومات الهوية وبيانات الاتصال عبر الإنترنت",
  "description": "مولد عناوين بنغلاديش مجاني عبر الإنترنت ينشئ عناوين بنغلاديش بتنسيق حقيقي وأرقام الهوية وأرقام الهواتف وأرقام بطاقات الائتمان وملفات هوية كاملة. يدعم التصفية حسب المحافظة وتصدير JSON/CSV ويعمل بالكامل في المتصفح لحماية الخصوصية.",
  ...
  "idCardTitle": "البطاقة الشخصية بنغلاديش",
