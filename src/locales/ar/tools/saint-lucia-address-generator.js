export default {
  "name": "مولد العناوين سانت لوسيا - توليد عناوين سانت لوسيا حقيقية ومعلومات الهوية وبيانات الاتصال عبر الإنترنت",
  "description": "مولد عناوين سانت لوسيا مجاني عبر الإنترنت ينشئ عناوين سانت لوسيا بتنسيق حقيقي وأرقام الهوية وأرقام الهواتف وأرقام بطاقات الائتمان وملفات هوية كاملة. يدعم التصفية حسب المحافظة وتصدير JSON/CSV ويعمل بالكامل في المتصفح لحماية الخصوصية.",
  ...
  "idCardTitle": "البطاقة الشخصية سانت لوسيا",
