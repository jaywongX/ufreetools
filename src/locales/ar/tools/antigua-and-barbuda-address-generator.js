export default {
  "name": "مولد العناوين أنتيغوا وبربودا - توليد عناوين أنتيغوا وبربودا حقيقية ومعلومات الهوية وبيانات الاتصال عبر الإنترنت",
  "description": "مولد عناوين أنتيغوا وبربودا مجاني عبر الإنترنت ينشئ عناوين أنتيغوا وبربودا بتنسيق حقيقي وأرقام الهوية وأرقام الهواتف وأرقام بطاقات الائتمان وملفات هوية كاملة. يدعم التصفية حسب المحافظة وتصدير JSON/CSV ويعمل بالكامل في المتصفح لحماية الخصوصية.",
  ...
  "idCardTitle": "البطاقة الشخصية أنتيغوا وبربودا",
