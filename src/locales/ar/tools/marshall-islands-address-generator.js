export default {
  "name": "مولد العناوين جزر مارشال - توليد عناوين جزر مارشال حقيقية ومعلومات الهوية وبيانات الاتصال عبر الإنترنت",
  "description": "مولد عناوين جزر مارشال مجاني عبر الإنترنت ينشئ عناوين جزر مارشال بتنسيق حقيقي وأرقام الهوية وأرقام الهواتف وأرقام بطاقات الائتمان وملفات هوية كاملة. يدعم التصفية حسب المحافظة وتصدير JSON/CSV ويعمل بالكامل في المتصفح لحماية الخصوصية.",
  ...
  "idCardTitle": "البطاقة الشخصية جزر مارشال",
