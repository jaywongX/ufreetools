export default {
  "name": "مولد العناوين الرأس الأخضر - توليد عناوين الرأس الأخضر حقيقية ومعلومات الهوية وبيانات الاتصال عبر الإنترنت",
  "description": "مولد عناوين الرأس الأخضر مجاني عبر الإنترنت ينشئ عناوين الرأس الأخضر بتنسيق حقيقي وأرقام الهوية وأرقام الهواتف وأرقام بطاقات الائتمان وملفات هوية كاملة. يدعم التصفية حسب المحافظة وتصدير JSON/CSV ويعمل بالكامل في المتصفح لحماية الخصوصية.",
  ...
  "idCardTitle": "البطاقة الشخصية الرأس الأخضر",
