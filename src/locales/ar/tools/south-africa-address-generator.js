export default {
  "name": "مولد العناوين جنوب أفريقيا - توليد عناوين جنوب أفريقيا حقيقية ومعلومات الهوية وبيانات الاتصال عبر الإنترنت",
  "description": "مولد عناوين جنوب أفريقيا مجاني عبر الإنترنت ينشئ عناوين جنوب أفريقيا بتنسيق حقيقي وأرقام الهوية وأرقام الهواتف وأرقام بطاقات الائتمان وملفات هوية كاملة. يدعم التصفية حسب المحافظة وتصدير JSON/CSV ويعمل بالكامل في المتصفح لحماية الخصوصية.",
  ...
  "idCardTitle": "البطاقة الشخصية جنوب أفريقيا",
