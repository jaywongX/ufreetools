export default {
  "name": "مولد العناوين البوسنة والهرسك - توليد عناوين البوسنة والهرسك حقيقية ومعلومات الهوية وبيانات الاتصال عبر الإنترنت",
  "description": "مولد عناوين البوسنة والهرسك مجاني عبر الإنترنت ينشئ عناوين البوسنة والهرسك بتنسيق حقيقي وأرقام الهوية وأرقام الهواتف وأرقام بطاقات الائتمان وملفات هوية كاملة. يدعم التصفية حسب المحافظة وتصدير JSON/CSV ويعمل بالكامل في المتصفح لحماية الخصوصية.",
  ...
  "idCardTitle": "البطاقة الشخصية البوسنة والهرسك",
