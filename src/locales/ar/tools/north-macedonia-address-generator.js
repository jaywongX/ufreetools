export default {
  "name": "مولد العناوين مقدونيا الشمالية - توليد عناوين مقدونيا الشمالية حقيقية ومعلومات الهوية وبيانات الاتصال عبر الإنترنت",
  "description": "مولد عناوين مقدونيا الشمالية مجاني عبر الإنترنت ينشئ عناوين مقدونيا الشمالية بتنسيق حقيقي وأرقام الهوية وأرقام الهواتف وأرقام بطاقات الائتمان وملفات هوية كاملة. يدعم التصفية حسب المحافظة وتصدير JSON/CSV ويعمل بالكامل في المتصفح لحماية الخصوصية.",
  ...
  "idCardTitle": "البطاقة الشخصية مقدونيا الشمالية",
