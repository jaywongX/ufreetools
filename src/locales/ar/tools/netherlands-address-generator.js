export default {
    name: 'مولّد عناوين هولندا - إنشاء عناوين هولندية حقيقية ومعلومات الهوية وبيانات الاتصال عبر الإنترنت',
    description: 'مولّد عناوين هولندي مجاني عبر الإنترنت ينشئ عناوين هولندية بصيغة حقيقية وأرقام هوية وأرقام هواتف وأرقام بطاقات ائتمان وملفات هوية كاملة. يدعم التصفية حسب المحافظة وتنسيقات التصدير JSON/CSV ويتم تشغيله بالكامل في المتصفح لحماية الخصوصية.',
    ...
    selectRegion: 'اختيار المحافظة',
    allRegions: 'جميع المحافظات',
    ...
    // بطاقة الهوية
    idCardTitle: 'بطاقة الهوية الهولندية',
    ...
    universities: {
        'UvA': 'جامعة أمستردام',
        'VU': 'جامعة أمستردام الحرة',
        'TU': 'جامعة دلفت للتكنولوجيا',
        'UU': 'جامعة أوتريخت',
        'EUR': 'جامعة إراسموس روتردام',
        'RUG': 'جامعة خرنغن',
        'WUR': 'جامعة فاغنينغن',
        'UL': 'جامعة لايدن',
        'RU': 'جامعة رادبود',
