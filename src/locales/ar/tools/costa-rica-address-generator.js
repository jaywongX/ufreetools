export default {
  "name": "مولد العناوين كوستاريكا - توليد عناوين كوستاريكا حقيقية ومعلومات الهوية وبيانات الاتصال عبر الإنترنت",
  "description": "مولد عناوين كوستاريكا مجاني عبر الإنترنت ينشئ عناوين كوستاريكا بتنسيق حقيقي وأرقام الهوية وأرقام الهواتف وأرقام بطاقات الائتمان وملفات هوية كاملة. يدعم التصفية حسب المحافظة وتصدير JSON/CSV ويعمل بالكامل في المتصفح لحماية الخصوصية.",
  ...
  "idCardTitle": "البطاقة الشخصية كوستاريكا",
