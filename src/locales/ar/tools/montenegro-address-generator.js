export default {
  "name": "مولد العناوين الجبل الأسود - توليد عناوين الجبل الأسود حقيقية ومعلومات الهوية وبيانات الاتصال عبر الإنترنت",
  "description": "مولد عناوين الجبل الأسود مجاني عبر الإنترنت ينشئ عناوين الجبل الأسود بتنسيق حقيقي وأرقام الهوية وأرقام الهواتف وأرقام بطاقات الائتمان وملفات هوية كاملة. يدعم التصفية حسب المحافظة وتصدير JSON/CSV ويعمل بالكامل في المتصفح لحماية الخصوصية.",
  ...
  "idCardTitle": "البطاقة الشخصية الجبل الأسود",
