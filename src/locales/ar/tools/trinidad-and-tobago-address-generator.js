export default {
  "name": "مولد العناوين ترينيداد وتوباغو - توليد عناوين ترينيداد وتوباغو حقيقية ومعلومات الهوية وبيانات الاتصال عبر الإنترنت",
  "description": "مولد عناوين ترينيداد وتوباغو مجاني عبر الإنترنت ينشئ عناوين ترينيداد وتوباغو بتنسيق حقيقي وأرقام الهوية وأرقام الهواتف وأرقام بطاقات الائتمان وملفات هوية كاملة. يدعم التصفية حسب المحافظة وتصدير JSON/CSV ويعمل بالكامل في المتصفح لحماية الخصوصية.",
  ...
  "idCardTitle": "البطاقة الشخصية ترينيداد وتوباغو",
