export default {
  "name": "مولد العناوين النمسا - توليد عناوين النمسا حقيقية ومعلومات الهوية وبيانات الاتصال عبر الإنترنت",
  "description": "مولد عناوين النمسا مجاني عبر الإنترنت ينشئ عناوين النمسا بتنسيق حقيقي وأرقام الهوية وأرقام الهواتف وأرقام بطاقات الائتمان وملفات هوية كاملة. يدعم التصفية حسب المحافظة وتصدير JSON/CSV ويعمل بالكامل في المتصفح لحماية الخصوصية.",
  ...
  "idCardTitle": "البطاقة الشخصية النمسا",
