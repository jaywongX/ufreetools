export default {
  "name": "مولد العناوين أوزبكستان - توليد عناوين أوزبكستان حقيقية ومعلومات الهوية وبيانات الاتصال عبر الإنترنت",
  "description": "مولد عناوين أوزبكستان مجاني عبر الإنترنت ينشئ عناوين أوزبكستان بتنسيق حقيقي وأرقام الهوية وأرقام الهواتف وأرقام بطاقات الائتمان وملفات هوية كاملة. يدعم التصفية حسب المحافظة وتصدير JSON/CSV ويعمل بالكامل في المتصفح لحماية الخصوصية.",
  ...
  "idCardTitle": "البطاقة الشخصية أوزبكستان",
