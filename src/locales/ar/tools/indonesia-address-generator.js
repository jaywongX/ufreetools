export default {
  "name": "مولد العناوين إندونيسيا - توليد عناوين إندونيسيا حقيقية ومعلومات الهوية وبيانات الاتصال عبر الإنترنت",
  "description": "مولد عناوين إندونيسيا مجاني عبر الإنترنت ينشئ عناوين إندونيسيا بتنسيق حقيقي وأرقام الهوية وأرقام الهواتف وأرقام بطاقات الائتمان وملفات هوية كاملة. يدعم التصفية حسب المحافظة وتصدير JSON/CSV ويعمل بالكامل في المتصفح لحماية الخصوصية.",
  ...
  "idCardTitle": "البطاقة الشخصية إندونيسيا",
