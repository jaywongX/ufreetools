export default {
  "name": "مولد العناوين كوريا الشمالية - توليد عناوين كوريا الشمالية حقيقية ومعلومات الهوية وبيانات الاتصال عبر الإنترنت",
  "description": "مولد عناوين كوريا الشمالية مجاني عبر الإنترنت ينشئ عناوين كوريا الشمالية بتنسيق حقيقي وأرقام الهوية وأرقام الهواتف وأرقام بطاقات الائتمان وملفات هوية كاملة. يدعم التصفية حسب المحافظة وتصدير JSON/CSV ويعمل بالكامل في المتصفح لحماية الخصوصية.",
  ...
  "idCardTitle": "البطاقة الشخصية كوريا الشمالية",
